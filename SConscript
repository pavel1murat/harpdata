...
#------------------------------------------------------------------------------
def harp_gen_rootcint(source, target, env, for_signature):
#    print "\n>>> harp_gen_rootcint called:"
...
#    print "[harp_gen_rootcint] class_include = %s"%class_include
#    print "[harp_gen_rootcint] linkdef       = %s"%linkdef
...
harp_my_rootcint = Builder(generator     = harp_gen_rootcint,
                           single_source = 0,
                           suffix        = '.o',
                           src_suffix    = '.h')

env.Append(BUILDERS = {'HarpRootCint' : harp_my_rootcint})
...
class harp_helper:
    ...
    def __init__(self,debug = False):
        ...
        env['HARP_TMP_LIB_DIR'] = 'tmp/src/'+self.d1

    def set_libname(self,libname):
...
#        print "[harp/obj] list_of_linkdef_files = \n",list_of_linkdef_files
        list_of_dict_files    = []
        ...
        for f in list_of_linkdef_files:
            ...
            env.HarpRootCint(dict,[f,include])
#------------------------------------------------------------------------------
